...
<body style="background: linear-gradient(135deg, #f0fdf4 0%, var(--white) 50%, #fef7ff 100%); min-height: 100vh; display: flex; align-items: center; justify-content: center;">
    ...
    <script>
        ...
        forgotPasswordForm.addEventListener('submit', function(e) {
            ...
            // In real implementation, this would make an AJAX request to your server
            setTimeout(function() {
                // Hide modal
                hideModal();
                ...
                // Optional: You could also redirect to a confirmation page
                // window.location.href = 'password-reset-sent.jsp';
